...
from LSKfenzu22 import LSKfenzu22
...
def main():
    ...
    # train_parser.add_argument("--upscale", type=int, default=4, help="hidden_feats, default set to 15")
    # train_parser.add_argument("--planes", type=int, default=65, help="hidden_feats, default set to 15")
    # train_parser.add_argument("--num_modules", type=int, default=11, help="hidden_feats, default set to 15")
    train_parser.add_argument("--out_feats", type=int, default=65, help="hidden_feats, default set to 256")
    ...
    train_parser.add_argument("--n_blocks", type=int, default=11, help="n_blocks, default set to 6")
    train_parser.add_argument("--b_blocks", type=int, default=3, help="n_blocks, default set to 6")
    train_parser.add_argument("--n_subs", type=int, default=4, help="n_subs, default set to 8")
    train_parser.add_argument("--n_ovls", type=int, default=1, help="n_ovls, default set to 1")
    ...
    train_parser.add_argument("--model_title", type=str, default="LSKfenzu22lossgraspe", help="model_title, default set to model_title")
    ...
    test_parser.add_argument("--upscale", type=int, default=4, help="hidden_feats, default set to 15")
    test_parser.add_argument("--planes", type=int, default=65, help="hidden_feats, default set to 15")
    test_parser.add_argument("--num_modules", type=int, default=11, help="hidden_feats, default set to 15")
    test_parser.add_argument("--out_feats", type=int, default=65, help="hidden_feats, default set to 256")
    ...
    test_parser.add_argument("--n_blocks", type=int, default=11, help="n_blocks, default set to 3")
    test_parser.add_argument("--b_blocks", type=int, default=3, help="n_blocks, default set to 6")
    test_parser.add_argument("--n_subs", type=int, default=4, help="n_subs, default set to 4")
    test_parser.add_argument("--n_ovls", type=int, default=1, help="n_ovls, default set to 1")
    ...
    test_parser.add_argument("--model_title", type=str, default="LSKfenzu22graspe", help="model_title, default set to model_title")
...
def train(args):
    ...
    net = LSKfenzu22(n_subs=args.n_subs, n_ovls=args.n_ovls, in_feats=channels, b_blocks=args.b_blocks,n_blocks=args.n_blocks, out_feats=args.out_feats, n_scale=args.n_scale, res_scale=0.1, use_share=args.use_share, conv=default_conv, )
    # print(net)
    model_title = "SSPSREXP_"+args.dataset_name + "_x" + str(args.n_scale) + "_" + args.model_title+ 'B_Blocks=' + str(args.b_blocks) +  '_Blocks=' + str(args.n_blocks) + '_Subs' + str(args.n_subs) + '_Ovls' + str(args.n_ovls) + '_Feats=' + str(args.out_feats)
    ...
    h_loss = HLoss5(0.5,0.1,spatial_tv=True, spectral_tv=True)
    ...
    for e in range(start_epoch, args.epochs):
        ...
        for iteration, (x, lms, gt) in enumerate(train_loader): 
            ...
            if (iteration + log_interval) % log_interval == 0:
                print(
                    "===> {} BB{} B{} Sub{} Feat{} GPU{}\tEpoch[{}]({}/{}): Loss: {:.6f}".format(time.ctime(), args.b_blocks,args.n_blocks,
